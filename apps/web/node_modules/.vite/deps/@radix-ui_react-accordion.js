...
var AccordionImplSingle = React4.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
    ...
    return (0, import_jsx_runtime3.jsx)(
      AccordionValueProvider,
      {
        ...
        value: React4.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: React4.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
...
var AccordionImplMultiple = React4.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleItemOpen = React4.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = React4.useCallback(
...
var AccordionImpl = React4.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = React4.useRef(null);
...
var AccordionContent = React4.forwardRef(
  (props, forwardedRef) => {
