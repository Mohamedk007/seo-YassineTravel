...
export default [
	{ ignores: ['node_modules/**', 'dist/**', 'build/**', 'vite.config.js', 'vite.config.ssr.js', 'tools/seo-check.vite.config.js'] },
	{
		files: ['**/*.js', '**/*.jsx'],
	...
	{ files: ['tools/**/*.js', 'tools/**/*.jsx', 'tailwind.config.js'], languageOptions: { globals: globals.node } },
];
